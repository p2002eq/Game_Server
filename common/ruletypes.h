...
RULE_REAL(Combat, MeleePushForceClient, 0.01) // percent to add or remove from push for players
RULE_REAL(Combat, MeleePushForcePet, 0.01) // percent to add or remove from push for pets
